...
> HD Wallet derivations from [mnemonic] seed in Go (golang). Implements the [go-ethereum](https://github.com/ethereum/go-ethereum) [`accounts.Wallet`](https://github.com/ethereum/go-ethereum/blob/master/accounts/accounts.go) [`address.Address`](https://github.com/fbsobreira/gotron-sdk/blob/master/pkg/address/address.go) interface.
